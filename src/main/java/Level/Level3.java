...
public class Level3 extends AbstractLevel {
    ...
    public void startLevel(Wizard wizard) {
        ...
        String INTRO_LVL3 = "Vous êtes de retour à Poudlard, et vous vous rendez à la Grande Salle pour une réunion d'urgence. Le professeur Dumbledore vous informe que les Détraqueurs se sont échappés de la prison d'Azkaban et qu'ils errent maintenant librement dans les rues et les campagnes, aspirant l'espoir et le bonheur de quiconque croise leur chemin. Cependant, il y a un sort qui peut les mettre en fuite : Expecto Patronum. Dumbledore vous demande de vous entraîner à ce sort et de vous préparer à affronter les Détraqueurs.";
