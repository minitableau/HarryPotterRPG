...
public class Level1 {
    ...
    public static void level1(Wizard wizard) throws InterruptedException {
        ...
        String FIN_ANNEE = "Vous vous remettez de vos blessures et fêtait la fin d'année. Vous vous retrouvez dans la salle principale de Poudlard, où le professeur Dumbledore annonce la maisons ayant récolté le plus de points : il s'agit de ";
        ...
        String GO_MARKET = "Vous passez brillamment votre première année et rentrer chez vous durant les vacances. Plusieurs semaines s'écoulent, voilà arriver la rentrée.";
...
//                wizard.setMaxLifePoint(wizard.getMaxLifePoint() + chosenPotion.getValue());
    ...
    private static void secondaryQuest(Wizard wizard) throws InterruptedException {
        ...
        if (win) {
            ...
            String LOSE_TICTACTOE = "Vous êtes frappez par un objet, celui-ci vous assomme vous perdez 24 points de vie. Vous vous réveillez à l'hôpital. Le professeur Dumbledore est présent à votre réveil et choisi de punir votre maison car vous avez pris des risques inconsidérés malgré les règles. Celle-ci perd 20 points";
